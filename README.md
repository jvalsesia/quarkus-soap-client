...
You can then execute your native executable with: `./target/quarkus-soap-client-1.0.0-SNAPSHOT-runner`
...
curl --location 'http://localhost:8084/cxf/hello-client/hello/?name=julio'